(function () {
  ...
  function ctaIdentityQuestion() { return '您好，请问您是本病例设定的 ×' + ctaIdentityHonorific() + ' 吗？为了保障安全，请您说一下年龄和今天来诊的主要原因。'; }
  function ctaIdentityAnswer() { return '是的，我是本病例设定的 ×' + ctaIdentityHonorific() + '，今年 ' + state.person.age + ' 岁，今天因为“' + state.person.complaint + '”来诊。'; }
